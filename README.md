...
- Ready for **Ansible Galaxy** as a standalone role (`v0.1.0`) with `galaxy.yml`/`meta/main.yml` in place.
...
# import to Galaxy
ansible-galaxy role import jhonnygo ansible-role-web_apache
